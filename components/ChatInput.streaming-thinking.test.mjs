...
const thinkingControl = source.slice(source.indexOf("{!modelSwitching && onThinkingLevelChange && ("));
...
test("keeps one thinking control and disables it while the session is busy", () => {
  ...
  assert.match(thinkingControl, /disabled=\{isStreaming \|\| modelSwitching\}/);
