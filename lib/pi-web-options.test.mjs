...
// Spawns the CLI as a child process; skipped where spawning is denied.
test("CLI writes help and parse errors before exiting", { skip: process.env.PI_WEB_TEST_NO_SPAWN === "1" }, () => {
