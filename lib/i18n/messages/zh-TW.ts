...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.searchSessions": "搜尋工作階段（名稱 / 首則訊息）",
    "sidebar.currentWork": "目前工作",
    "sidebar.allSessions": "所有工作階段",
    "sidebar.activeSessions": "進行中",
    "sidebar.today": "今天",
    ...
    "sidebar.unpin": "取消置頂",
    "sidebar.pinned": "已置頂",
    "sidebar.moveToFolder": "移入資料夾",
    "sidebar.noFoldersYet": "還沒有資料夾，先建立一個",
    "sidebar.newFolder": "新增資料夾",
    "sidebar.newSessionInFolder": "在此資料夾中新增工作階段",
    "sidebar.newSubfolder": "新增子資料夾",
    "sidebar.folderRule": "自動歸類規則",
    "sidebar.folderRulePlaceholder": "新工作階段 cwd 包含此關鍵字時自動歸入（留空清除）",
    "sidebar.moveFolder": "移動資料夾",
    "sidebar.moveToTopLevel": "移到頂層",
    "sidebar.folderName": "資料夾名稱",
    "sidebar.renameFolder": "重新命名資料夾",
    "sidebar.deleteFolder": "刪除資料夾（工作階段保留）",
    "sidebar.deleteFolderConfirm": "刪除資料夾 {name}？其中的工作階段不會被刪除。",
    "sidebar.ungrouped": "未分組",
    "sidebar.bulkSelect": "批次選擇",
    "sidebar.bulkExit": "結束批次選擇",
    "sidebar.bulkSelectedCount": "已選 {count} 個工作階段",
    "sidebar.bulkSelectAll": "全選",
    "sidebar.bulkDelete": "刪除 {count} 個",
    "sidebar.bulkDeleting": "刪除中…",
    "sidebar.bulkRunningProtected": "執行中的工作階段不可刪除",
    "files.modified": "已修改",
    "files.added": "已新增",
    "files.deleted": "已刪除",
    "files.renamed": "已重新命名",
    ...
    "chat.permissionRequired": "需要權限確認",
    "chat.permissionRequest": "Agent 操作需要你的核准",
    "chat.permissionSubagentRequest": "子 Agent 操作需要你的核准",
    "chat.permissionWaiting": "等待處理",
    "chat.permissionAgent": "請求方",
    "chat.permissionCommand": "命令",
    "chat.permissionTool": "工具",
    "chat.permissionSkill": "技能",
    "chat.permissionTarget": "目標",
    "chat.permissionMatchedRule": "符合規則",
    "chat.permissionWorkingDirectory": "工作目錄",
    "chat.permissionExternalPaths": "外部路徑",
    "chat.permissionShowDetails": "查看原始請求",
    "chat.permissionHideDetails": "收起原始請求",
    "chat.permissionAllowOnce": "允許一次",
    "chat.permissionAllowSession": "本工作階段允許",
    "chat.permissionDeny": "拒絕",
    "chat.permissionDenyReason": "拒絕並說明原因",
    "chat.permissionReasonPrompt": "告訴 Agent 為什麼拒絕此操作",
    "chat.permissionReasonPlaceholder": "此原因將回饋給 Agent",
    "chat.permissionSubmitDenial": "確認拒絕",
    "chat.cancel": "取消",
    "chat.confirm": "確認",
    "chat.submit": "送出",
    ...
    "chat.anchorModePrompt": "回覆時釘住提問（點選切換為貼底跟隨）",
    "chat.anchorModeTail": "回覆時貼底跟隨（點選切換為釘住提問）",
