...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.searchSessionsTree": "搜尋工作階段（名稱 / 首則訊息）",
    ...
    "chat.imageGenBadge": "生圖",
    "chat.imageGenPlaceholder": "描述你想產生的畫面，可附加 / 貼上參考圖進行圖生圖…",
    "chat.imageGenSend": "產生",
    "chat.imageOverLimit": "目前附有 {count} 張圖片，每則訊息最多 {max} 張。圖片均保留在此草稿中，請移除部分圖片後再傳送或加入佇列。",
    "chat.removeImage": "移除第 {index} 張圖片",
    "chat.imageGenRatio": "比例",
    "chat.imageGenCount": "數量",
    "chat.imageGenSeed": "種子",
    "chat.imageGenSeedHint": "固定 seed 可重現結果",
    "chat.imageGenModeSwitch": "輸入模式",
    "chat.imageGenModeChat": "對話",
    "chat.imageGenModeImage": "生圖",
    "chat.imageGenModelSelector": "選擇生圖模型",
    "chat.imageGenCardCount": "{count} 張",
    "chat.imageGenCardGenerating": "正在產生圖片…",
    "chat.imageGenCardReuse": "複用提示詞",
    "chat.imageGenCardDownload": "下載",
    "chat.imageGenCardSave": "存到專案",
    "chat.imageGenCardSaving": "儲存中…",
    "chat.imageGenCardSavedShort": "已儲存",
    "chat.imageGenCardSaved": "已儲存為 {file}",
