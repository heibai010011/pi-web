...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.searchSessions": "Search sessions (name / first message)",
    ...
    "chat.responding": "Still responding",
    ...
    "chat.permissionRequest": "Agent action needs your approval",
    "chat.permissionSubagentRequest": "Subagent action needs your approval",
    "chat.permissionWaiting": "Waiting",
    "chat.permissionAgent": "Agent",
    "chat.permissionCommand": "Command",
    "chat.permissionTool": "Tool",
    "chat.permissionSkill": "Skill",
    "chat.permissionTarget": "Target",
    "chat.permissionMatchedRule": "Matched rule",
    "chat.permissionWorkingDirectory": "Working directory",
    "chat.permissionExternalPaths": "External paths",
    "chat.permissionShowDetails": "Show original request",
    "chat.permissionHideDetails": "Hide original request",
    "chat.permissionAllowOnce": "Allow once",
    "chat.permissionAllowSession": "Allow for session",
    "chat.permissionDeny": "Deny",
    "chat.permissionDenyReason": "Deny with reason",
    "chat.permissionReasonPrompt": "Tell the agent why this action was denied",
    "chat.permissionReasonPlaceholder": "Reason shown back to the agent",
