...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.searchSessionsTree": "Search sessions (name / first message)",
    "sidebar.currentWork": "Current work",
    "sidebar.allSessions": "All sessions",
    "sidebar.activeSessions": "Active",
    "sidebar.today": "Today",
    ...
    "sidebar.folderRule": "Auto-classify rule",
    "sidebar.folderRulePlaceholder": "Auto-assign new sessions whose cwd contains this keyword (empty to clear)",
    "sidebar.moveFolder": "Move folder",
    "sidebar.moveToTopLevel": "Move to top level",
    "sidebar.folderName": "Folder name",
    "sidebar.renameFolder": "Rename folder",
    "sidebar.deleteFolder": "Delete folder (sessions are kept)",
    "sidebar.deleteFolderConfirm": "Delete folder {name}? Sessions inside are kept.",
    "sidebar.ungrouped": "Ungrouped",
    "sidebar.bulkSelect": "Bulk select",
    "sidebar.bulkExit": "Exit bulk select",
    "sidebar.bulkSelectedCount": "{count} selected",
    "sidebar.bulkSelectAll": "Select all",
    "sidebar.bulkDelete": "Delete {count}",
    "sidebar.bulkDeleting": "Deleting…",
    "sidebar.bulkRunningProtected": "Running sessions cannot be deleted",
    ...
    "chat.permissionSubmitDenial": "Deny request",
    ...
    "chat.imageGenBadge": "image",
    "chat.imageGenPlaceholder": "Describe the image to generate — attach or paste reference images for image-to-image…",
    "chat.imageGenSend": "Generate",
    "chat.imageOverLimit": "{count} images are attached; a message allows at most {max}. All are retained in this draft. Remove images to send or queue.",
    "chat.removeImage": "Remove image {index}",
    "chat.imageGenRatio": "Ratio",
    "chat.imageGenCount": "Count",
    "chat.imageGenSeed": "Seed",
    "chat.imageGenSeedHint": "Fix a seed for reproducible results",
    "chat.imageGenModeSwitch": "Composer mode",
    "chat.imageGenModeChat": "Chat",
    "chat.imageGenModeImage": "Image",
    "chat.imageGenModelSelector": "Select image model",
    "chat.imageGenCardCount": "{count} image(s)",
    "chat.imageGenCardGenerating": "Generating images…",
    "chat.imageGenCardReuse": "Reuse prompt",
    "chat.imageGenCardDownload": "Download",
    "chat.imageGenCardSave": "Save to project",
    "chat.imageGenCardSaving": "Saving…",
    "chat.imageGenCardSavedShort": "Saved",
    "chat.imageGenCardSaved": "Saved as {file}",
