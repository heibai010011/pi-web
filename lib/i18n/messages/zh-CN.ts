...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.searchSessions": "搜索会话（名称 / 首条消息）",
    ...
    "chat.permissionRequired": "需要权限确认",
    "chat.permissionRequest": "Agent 操作需要你的批准",
    "chat.permissionSubagentRequest": "子 Agent 操作需要你的批准",
    "chat.permissionWaiting": "等待处理",
    "chat.permissionAgent": "请求方",
    "chat.permissionCommand": "命令",
    "chat.permissionTool": "工具",
    "chat.permissionSkill": "技能",
    "chat.permissionTarget": "目标",
    "chat.permissionMatchedRule": "命中规则",
    "chat.permissionWorkingDirectory": "工作目录",
    "chat.permissionExternalPaths": "外部路径",
    "chat.permissionShowDetails": "查看原始请求",
    "chat.permissionHideDetails": "收起原始请求",
    "chat.permissionAllowOnce": "允许一次",
    "chat.permissionAllowSession": "本会话允许",
    "chat.permissionDeny": "拒绝",
    "chat.permissionDenyReason": "拒绝并说明原因",
    "chat.permissionReasonPrompt": "告诉 Agent 为什么拒绝此操作",
    "chat.permissionReasonPlaceholder": "此原因将反馈给 Agent",
