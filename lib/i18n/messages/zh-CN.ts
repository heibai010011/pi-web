...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.searchSessionsTree": "搜索会话（名称 / 首条消息）",
    "sidebar.currentWork": "当前工作",
    "sidebar.allSessions": "所有会话",
    "sidebar.activeSessions": "进行中",
    "sidebar.today": "今天",
    ...
    "sidebar.folderRule": "自动归类规则",
    "sidebar.folderRulePlaceholder": "新会话 cwd 包含此关键字时自动归入（留空清除）",
    "sidebar.moveFolder": "移动文件夹",
    "sidebar.moveToTopLevel": "移到顶层",
    "sidebar.folderName": "文件夹名称",
    "sidebar.renameFolder": "重命名文件夹",
    "sidebar.deleteFolder": "删除文件夹（会话保留）",
    "sidebar.deleteFolderConfirm": "删除文件夹 {name}？其中的会话不会被删除。",
    "sidebar.ungrouped": "未分组",
    "sidebar.bulkSelect": "批量选择",
    "sidebar.bulkExit": "退出批量选择",
    "sidebar.bulkSelectedCount": "已选 {count} 个会话",
    "sidebar.bulkSelectAll": "全选",
    "sidebar.bulkDelete": "删除 {count} 个",
    "sidebar.bulkDeleting": "删除中…",
    "sidebar.bulkRunningProtected": "运行中的会话不可删除",
    "files.modified": "已修改",
    "files.added": "已添加",
    "files.deleted": "已删除",
    "files.renamed": "已重命名",
    ...
    "chat.permissionSubmitDenial": "确认拒绝",
    ...
    "chat.imageGenBadge": "生图",
    "chat.imageGenPlaceholder": "描述你想生成的画面，可附加 / 粘贴参考图进行图生图…",
    "chat.imageGenSend": "生成",
    "chat.imageOverLimit": "当前附有 {count} 张图片，每条消息最多 {max} 张。图片均保留在此草稿中，请移除部分图片后再发送或加入队列。",
    "chat.removeImage": "移除第 {index} 张图片",
    "chat.imageGenRatio": "比例",
    "chat.imageGenCount": "数量",
    "chat.imageGenSeed": "种子",
    "chat.imageGenSeedHint": "固定 seed 可复现结果",
    "chat.imageGenModeSwitch": "输入模式",
    "chat.imageGenModeChat": "对话",
    "chat.imageGenModeImage": "生图",
    "chat.imageGenModelSelector": "选择生图模型",
    "chat.imageGenCardCount": "{count} 张",
    "chat.imageGenCardGenerating": "正在生成图片…",
    "chat.imageGenCardReuse": "复用提示词",
    "chat.imageGenCardDownload": "下载",
    "chat.imageGenCardSave": "存到项目",
    "chat.imageGenCardSaving": "保存中…",
    "chat.imageGenCardSavedShort": "已保存",
    "chat.imageGenCardSaved": "已保存为 {file}",
