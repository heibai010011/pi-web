...
// Windows without Developer Mode / admin denies symlink() with EPERM; skip
// unless the environment explicitly opts in.
test("lists directories and directory symlinks without returning files", { skip: process.platform === "win32" && process.env.PI_WEB_TEST_ALLOW_SYMLINK !== "1" }, async () => {
